...
public class TriangleSquare implements Shape {
  ...
  public TriangleSquare(double x, double y, double sizeIn075mm, double pixelsPerPoint) {
    this.x = x;
    this.y = y;
    this.halfDim =
  ...
  private class PathIt extends PathIterators {
    ...
    public int currentSegment(float[] coords) {
      ...
      case 5: return e(x,         y-halfDim, coords);
      case 6: return e(x+halfDim, y+halfDim, coords);
      }
      return 0;
    }

...
import org.beastmachine.ggplot.Layer.OptionSetter;
import org.beastmachine.ggplot.geom.Geometry;

import com.google.common.base.Preconditions;

public class GeometryHline extends Geometry {
  ...
  public void draw(DataFrame plotData, Aes myAes, Scalable scale, Graphics2D g) {
    Preconditions.checkState(false, "geom_hline not yet supported");
  }
